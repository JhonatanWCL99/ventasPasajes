<x-app-layout>
    ...
    <div class="py-12">
        <div class="w-full mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <form action="{{route('viajes.reporteViajes')}}" method="GET">
                @csrf
                <p class="text-xl font-semibold mb-4">Seleccione Fechas a filtrar: </p>
                <div date-rangepicker class="flex items-center px-12">
                    <div class="relative">
                ...
                <div class=" md:w-1/2 px-12">
                    ...
                    <select name="lugar_llegada" id="ruta" @error('ruta') is-invalid @enderror class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 px-8 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 text-gray-700 mb-6">
        ...
        <table class="hover:table-fixed w-full  ">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Ruta Llegada</th>
